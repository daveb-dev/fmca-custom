...
class DerivateCovarianceKernel {
 public:
  DerivateCovarianceKernel(){};
  DerivateCovarianceKernel(const std::string &ktype, FMCA::Scalar l)
      : ktype_(ktype), l_(l) {
    // transform string to upper and check if kernel is implemented
    for (auto &c : ktype_) c = (char)toupper(c);
    ////////////////////////////////////////////////////////////////////////////
    if (ktype_ == "EXPONENTIAL")
      kernel_ = [this](FMCA::Scalar r) { return -r * exp(-r / l_); };
    ////////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////////
      ...
      kernel_ = [this](FMCA::Scalar r) { return r*  exp(-r * r / l_); };
    else
